...
<br/>
                                        <div class="form-group input-group" id="divCadNome">
                                         ...
                                         <div class="form-group input-group" id="divCadEmail">
                                            ...
                                            <input name="email" type="text" id="email" class="form-control" autocomplete="on" placeholder="Seu E-mail" onchange="ValidarEmailCadastrado(this.value)" onfocusout="SinalizaCampo('divCadEmail','email')" />
                                        </div>
